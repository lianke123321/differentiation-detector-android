...
Pre-condition:
    The current directory must contain a single "client.pcap" captured by "tcpdump"
    This file will be copied into a given "pcap_folder"
...
def run():
    ...
    for pcap_file in os.listdir('.'):
        if pcap_file.endswith('client.pcap'):
            ...
            os.system("mv " + pcap_file + " " + pcap_dir + "/" + pcap_file)
