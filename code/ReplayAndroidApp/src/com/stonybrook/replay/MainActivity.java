...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// In Android, Network cannot be done on Main thread. But Initially for testing
		// purposes this hack was placed which allowed network usage on main thread
		...
		try {			
			...
			//This method parses JSON file which contains details for different Applications
	...
	OnClickListener settingsButtonclick = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			final Button installCertButton = (Button)view.findViewById(R.id.installCertButton);
			 ...
			 * TODO: Here, user preference saving scope is only session based i.e. If user closes the
			 * application then all the saved preferences lost.
	...
	/**
	 * This method will be called when user clicks on the next button on main screen.
	 * This method redirects user to ReplayActivity page which display users apps selected
	 * on main page.
	 */
	OnClickListener nextButtonClick = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			// If user did not select anything from settings dialog then use default preferences and
	...
	/**
	 * This Method checks the network Availability. For this NetworkInfo class is used and
	 * this should also provide type of connectivity i.e. Wi-Fi, Cellular .. 
	 * @return
	 */
