...
public class Config {
	 ...
	 * @param configFile
	 * @param context_c
	 * Read properties file and put all of these key-value pairs in properties
	 */
	public static void readConfigFile(String configFile, Context context_c) throws Exception{
