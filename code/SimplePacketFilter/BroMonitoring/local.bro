...
# required for logging traffic generated by the same machine because checksums computation is offloaded to the card.
redef ignore_checksums = T;
# Arao: Testing stdout logging -- all logs go to stdout.log
