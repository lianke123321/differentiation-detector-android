setup()
{
    ...
    ip route add default via 128.208.4.100 dev eth1 table depart
    ip route add 128.208.4.0/24 dev eth1 table depart
    ...
    # Enable forwarding between the tun+ devices and the eth1 device
...
undo()
{
    ...
    ip route del default via 128.208.4.100 dev eth1 table depart
    ip route del 128.208.4.0/24 dev eth1 table depart
