...
A mobile devices can tunnel the traffic using either \wifi or cellular networks. 
...
In \fref{tab:summaryIOSAndroidTraffic} we present a summary of our dataset based on the classification provided by Bro~\cite{bro}.
