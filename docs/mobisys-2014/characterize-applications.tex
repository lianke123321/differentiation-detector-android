...
\begin{table}
    ...
    \end{tabular}
    \end{small}
    \caption{\textbf{Top 5 sites that receive PII, and the number of malwares sending them the PII.} \emph{Two of the top 5 sites that receive PII are stores from which users can download apps.}}
