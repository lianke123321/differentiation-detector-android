...
\subsection{ReCon: Visualizing and Controlling Privacy Leaks}
Given the extensive nature of tracking over mobile devices, we developed a tool, \emph{ReCon} that allows users to visualize their devices' tracking, and the apps that facilitate this tracking, with the help of a web-based interfaces similar to that of Mozilla Collusion~\cite{collusion}. \emph{ReCon} provides a visual interface that allows 
...
% \hline
% \end{tabular}}\newline
\subfloat[Highlighted view, showing apps tracked by Scorecard Research.]{\label{fig:recon-highlight} \includegraphics[width=0.47\columnwidth]{figures/ReConHighlight.pdf}}
...
Figure~\ref{fig:recon} depicts our visualization, showing the default view of trackers contacted by apps and how 
