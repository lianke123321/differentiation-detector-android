...
applications for mobile traffic. The system must support the ability to deploy and distribute large numbers 
...
\subsection{Control: Something for Controlling Traffic}
...
\subsection{Deployability: Something}
