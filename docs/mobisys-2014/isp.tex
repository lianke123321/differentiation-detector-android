...
\begin{figure}
\centering
\includegraphics[width=0.8\linewidth]{figures/tripnet.pdf}
\vspace{-1em}
...
Table~\ref{} shows the average throughput and loss (along with standard deviations) in Verizon's LTE network 
