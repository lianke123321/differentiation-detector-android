...
AT\&T, Verizon, and T-Mobile, using the following representative apps: \tbd{insert names and why}. 
We evaluate differentiation in terms of throughput, latency and packet loss. 
