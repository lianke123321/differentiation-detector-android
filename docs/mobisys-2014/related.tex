...
MobiPerf~\cite{wang:middleboxes}/SpeedTest~\cite{sommers:cellwifi} & Multiple networks & Android & Install App & Active \\ \hline \hline
\platname & Any network & Most OSes & VPN configuration & Passive \\ \hline
\end{tabular} }
\end{center}
\vspace{\postfigspace}
