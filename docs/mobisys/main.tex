...
\title{Transparency and Control for Mobile Network Traffic Using Meddle}
...
%AL: commented out because the latex document cannot compile due to
%the lack of this file
%\input{measurements}
