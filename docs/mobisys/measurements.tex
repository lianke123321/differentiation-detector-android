...
\label{sec:case-study-filtering}
    ...
    Over 30 minutes of active use with the movie app, the phone contacted Amazon, Google, and a single CDN provider; the average inter-packet transmission time was \tbd{x}.
    Over 30 minutes of active use with the settings app, the phone contacted Amazon, Google, a hosting service, and two CDN services; the average inter-packet transmission time was \tbd{y}.
    Over 30 minutes of active use with the game app, the phone contacted only Google and Amazon; while the average inter-packet transmision time was higher (\tbd{z}), we presume this was needed for updating the game scoreboard at the end of each game.\tbd{Amy, is this a reasonable estimate?}
